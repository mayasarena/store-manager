...
<center><h2 style="color: #428bca">Customer's purchased products:</h2></center>
<div style="background-color: #428bca; opacity: 0.7; text-align: center; 
padding: 40px; padding-left: 10px; width: 400px; margin: 0 auto;">
<!-- php script to get customer purchased products -->
<?php include "../getstuff/getcustomerprod.php";?>
</div>
</body>
</html>
